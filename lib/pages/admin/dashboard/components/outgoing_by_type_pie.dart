...
class OutgoingByTypePie extends StatefulWidget {
  const OutgoingByTypePie({super.key});

  @override
  OutgoingByTypePieState createState() => OutgoingByTypePieState();
}

class OutgoingByTypePieState extends State<OutgoingByTypePie>
  ...
  Future<void> _loadData() async {
    final value = await MasterCrudModel.post('/resume/operations/expenses');
