...
class WeeklyOperationTrend extends StatefulWidget {
  const WeeklyOperationTrend({super.key});

  @override
  WeeklyOperationTrendState createState() => WeeklyOperationTrendState();
}

class WeeklyOperationTrendState extends State<WeeklyOperationTrend> {
  ...
  Future<void> _loadData() async {
    try {
      final value = await MasterCrudModel.load('/resume/operations/weekly/trend');
  ...
  Widget _buildChart(ColorScheme colorScheme, bool isDark) {
    return Padding(
      ...
      child: SfCartesianChart(
        ...
        series: _buildChartSeries(colorScheme, isDark),
      ),
    );
  }
  ...
  List<CartesianSeries> _buildChartSeries(ColorScheme colorScheme, bool isDark) {
    return categories.map((category) {
      return SplineSeries<ChartData, String>(
        ...
        dataSource: data!
            .map((e) => ChartData(e[category.key], e['day_name']))
            .toList(),
        xValueMapper: (ChartData data, _) => data.x,
        yValueMapper: (ChartData data, _) => data.y,
        legendItemText: category.label,
