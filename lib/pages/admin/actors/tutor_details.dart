...
import 'package:novacole/pages/components/tutors_details/tutor_details_info_page.dart';
import 'package:novacole/pages/components/tutors_details/tutor_student_list_page.dart';
...
class TutorDetails extends StatefulWidget {
  ...
  @override
  TutorDetailsState createState() {
    return TutorDetailsState();
  }
}

class TutorDetailsState extends State<TutorDetails>
            ...
            child: Column(
              children: [
                _buildInfoRow(
                  ...
                  value: widget.tutor['birthdate'] != null
                      ? DateFormat('dd MMM yyyy').format(
                    DateTime.parse(
                      "${widget.tutor['birthdate']}".replaceAll('/', '-'),
                    ),
                  )
                      : '-',
                ),
                _buildInfoRow(
                  ...
                  value: widget.tutor['birth_city'] ?? '-',
                ),
                _buildInfoRow(
                  icon: Icons.person_outline,
                  label: 'Sexe',
                  value: widget.tutor['gender'] ?? '-',
                  translate: true,
                ),
                _buildInfoRow(
                  icon: Icons.phone_outlined,
      ...
      children: [
        ...
        Expanded(
          child: _buildStatCard(
            ...
            label: 'Adresse',
            value: widget.tutor['address'] != null ? 'OK' : '-',
            color: Colors.blue,
          ),
        ),
      ],
