...
class ModelFormInputDate extends StatefulWidget {
  final Map<String, dynamic> item;
  final String? initialValue;
  final Function onChange;
  final String? isRequired;

  const ModelFormInputDate({
    super.key,
    required this.item,
    this.initialValue,
  ...
  @override
  State createState() => ModelFormInputDateState();
}

class ModelFormInputDateState extends State<ModelFormInputDate> {
      ...
      child: TextFormField(
        ...
        onTap: () async {
          final pickedDate = await showDatePicker(
            ...
            firstDate: DateTime.now().add(const Duration(days: -36500)),
